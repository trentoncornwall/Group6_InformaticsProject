...
<div class="container-2">
    ...
    <table class='table table-hover'>
        ...
        <tbody>
			...
			$query = ("SELECT * FROM Business_T ORDER BY Business_Name;");
			...
			while ($row=nextTuple($result)) {
				echo "\n <tr>";
				echo "<td align=left> <a href='np-bus.php'>"  . $row['Business_Name'] .  "</a> </td>";
				echo "<td align=left>" . $row['Business_Address'] . "</td>";
				$query = ("SELECT * FROM Report_T as r, Business_T as b, Job_T as j WHERE r.JID = j.JID and j.BID =" . $row['BID'] . ";");
